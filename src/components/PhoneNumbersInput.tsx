...
export default function PhoneNumbersInput({
    ...
    // Ensure at least one phone row exists
    const phones = phoneNumbers.length > 0 
        ? phoneNumbers 
        : [{ id: generateId(), number: "", countryCode: defaultCountryCode, type: "mobile" as PhoneType }];
    ...
    useEffect(() => {
        if (openCountryIndex !== null && searchInputRef.current) {
    ...
    const handleCountrySelect = (index: number, countryCode: string) => {
        handlePhoneChange(index, "countryCode", countryCode);
        setOpenCountryIndex(null);
        setSearchTerm("");
    };
    ...
    const handleRemovePhone = (index: number) => {
        if (phones.length <= 1) return; // Keep at least one row
    ...
    return (
        <div className="space-y-3">
            {phones.map((phone, index) => {
                ...
                return (
                    <div key={phone.id} className="relative" ref={openCountryIndex === index ? dropdownRef : undefined}>
                        ...
                        <div className="flex flex-col sm:flex-row gap-2">
                            ...
                            <div className="flex-1 flex border border-border rounded-xl overflow-hidden focus-within:ring-2 focus-within:ring-forest/20 focus-within:border-forest bg-white">
                                ...
                                >
                                    ...
                                    <svg
                                        ...
                                        stroke="currentColor"
                                        strokeWidth="2"
                                        className={`text-textSub transition-transform ${openCountryIndex === index ? "rotate-180" : ""}`}
                                    >
                                        <path d="m6 9 6 6 6-6" />
                                    </svg>
                                </button>
                            ...
                            <div className="flex gap-2">
                                ...
                                <select
                                    ...
                                    className="h-11 px-3 border border-border rounded-xl text-sm bg-white focus:outline-none focus:ring-2 focus:ring-forest/20 focus:border-forest appearance-none cursor-pointer min-w-[100px]"
                                ...
                                {phones.length > 1 && (
                                    <button
                                        ...
                                        className="h-11 w-11 flex items-center justify-center border border-border rounded-xl text-textSub hover:text-red-500 hover:border-red-200 hover:bg-red-50 transition-colors shrink-0"
                                        title="Remove phone"
                                    >
                                    ...
                                    {filteredCountries.length === 0 ? (
                                        ...
                                        filteredCountries.map((country, cIndex) => (
                                            <button
                                                ...
                                                type="button"
                                                onClick={() => handleCountrySelect(index, country.code)}
            ...
            <button
                ...
                className="flex items-center gap-2 px-3 py-2 text-sm font-medium text-forest hover:bg-cream rounded-lg transition-colors"
            >
