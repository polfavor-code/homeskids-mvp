...
BEGIN
    ...
    -- 3. If guardian, add to child_guardians (this will trigger apply_guardian_defaults)
    ...
    -- 4. Add to child_access (upsert to handle both guardian and helper)
...
-- After running, update the invite acceptance code to use this function.
-- ============================================
